...
acc_df, gyr_df = read_csv_data_files(files)       
...
merged_data[:1000].resample(rule="250ms").apply(sampling)
...
resampled_data.to_pickle("../../data/interim/01_data_processed.pkly")